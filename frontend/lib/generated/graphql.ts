...
export type BuildInfoFragment = {
  ...
  createdAt: any;
  updatedAt: any;
} & { ' $fragmentName'?: 'BuildInfoFragment' };

export type PartInfoFragment = {
  __typename?: 'Part';
  id: string;
  buildId: string;
  name: string;
  ...
  quantity: number;
  createdAt: any;
} & { ' $fragmentName'?: 'PartInfoFragment' };

export type TestRunInfoFragment = {
  __typename?: 'TestRun';
  id: string;
  buildId: string;
  status: TestStatus;
...
export type GetBuildDetailQuery = {
  __typename?: 'Query';
  build?:
    | ({
        __typename?: 'Build';
        parts: Array<
          { __typename?: 'Part' } & { ' $fragmentRefs'?: { PartInfoFragment: PartInfoFragment } }
        >;
        testRuns: Array<
          { __typename?: 'TestRun' } & {
...
export type GetTestRunsQuery = {
  __typename?: 'Query';
  testRuns: Array<
    { __typename?: 'TestRun' } & { ' $fragmentRefs'?: { TestRunInfoFragment: TestRunInfoFragment } }
  >;
};
...
export type UpdateBuildStatusMutation = {
  __typename?: 'Mutation';
  updateBuildStatus: { __typename?: 'Build' } & {
    ' $fragmentRefs'?: { BuildInfoFragment: BuildInfoFragment };
  };
};
...
export type AddPartMutation = {
  __typename?: 'Mutation';
  addPart: { __typename?: 'Part' } & { ' $fragmentRefs'?: { PartInfoFragment: PartInfoFragment } };
};
...
export type SubmitTestRunMutation = {
  __typename?: 'Mutation';
  submitTestRun: { __typename?: 'TestRun' } & {
    ' $fragmentRefs'?: { TestRunInfoFragment: TestRunInfoFragment };
  };
};
  ...
  definitions: [
    {
      ...
      name: { kind: 'Name', value: 'BuildInfo' },
...
} as unknown as DocumentNode<BuildInfoFragment, unknown>;
export const PartInfoFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'PartInfo' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Part' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<PartInfoFragment, unknown>;
export const TestRunInfoFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'TestRunInfo' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'TestRun' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'id' } },
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetBuilds' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<GetBuildsQuery, GetBuildsQueryVariables>;
export const GetBuildDetailDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetBuildDetail' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
              ...
              selections: [
                { kind: 'FragmentSpread', name: { kind: 'Name', value: 'BuildInfo' } },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'FragmentSpread', name: { kind: 'Name', value: 'PartInfo' } },
                    ],
                  },
                },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'FragmentSpread', name: { kind: 'Name', value: 'TestRunInfo' } },
                    ],
                  },
                },
              ],
...
} as unknown as DocumentNode<GetBuildDetailQuery, GetBuildDetailQueryVariables>;
export const GetTestRunsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTestRuns' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<GetTestRunsQuery, GetTestRunsQueryVariables>;
...
export const UpdateBuildStatusDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateBuildStatus' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
        ...
        },
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'BuildStatus' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<UpdateBuildStatusMutation, UpdateBuildStatusMutationVariables>;
export const AddPartDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'AddPart' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'buildId' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'PartInfo' } }],
            },
          },
        ],
      },
...
} as unknown as DocumentNode<AddPartMutation, AddPartMutationVariables>;
export const SubmitTestRunDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SubmitTestRun' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'buildId' } },
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'fileUrl' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'fileUrl' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
